...
impl FatTable {
    ...
    pub fn cluster_offset(&self, cluster: u32) -> u64 {
        ...
        let cluster_heap_offset_bytes = self.cluster_heap_offset as u64 * self.bytes_per_sector as u64;
    ...
    pub fn find_orphaned_chains(&self, referenced_clusters: &std::collections::HashSet<u32>) -> Vec<(u32, Vec<u32>)> {
