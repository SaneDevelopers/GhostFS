...
impl ExtentReconstructor {
    ...
    pub fn new() -> Self {
        Self {
            matcher: FragmentMatcher::new().with_min_confidence(0.5),
            min_confidence: 0.6,
        }
    }
    ...
    fn choose_strategy(&self, file: &DeletedFile, catalog: &FragmentCatalog) -> ReconstructionStrategy {
    ...
    fn extend_range(
        ...
        loop {
            ...
            let next_block = &device_data[next_block_offset..next_block_offset + block_size as usize];
